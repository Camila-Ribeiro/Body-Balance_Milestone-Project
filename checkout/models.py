...
class ProductOrder(models.Model):
    ...
    order_total = models.DecimalField(max_digits=10, decimal_places=2,
                                      null=False, default=0)
    shop_total = models.DecimalField(max_digits=10, decimal_places=2,
                                     null=False, default=0)
    original_shop_bag = models.TextField(null=False, blank=False, default='')
    ...
    def update_total(self):
        ...
        self.order_total = self.lineorders.\
            aggregate(Sum('lineorder_total'))['lineorder_total__sum'] or 0
...
class ProductLineOrder(models.Model):
    order = models.ForeignKey(ProductOrder, null=False, blank=False,
                              on_delete=models.CASCADE,
                              related_name='lineorders')
    product = models.ForeignKey(Product, null=False, blank=False,
                                on_delete=models.CASCADE)
    # XS, S, M, L, XL
    product_size = models.CharField(max_length=2, null=True, blank=True)
    product_quantity = models.IntegerField(null=False, blank=False, default=0)
    lineorder_total = models.DecimalField(max_digits=6, decimal_places=2,
