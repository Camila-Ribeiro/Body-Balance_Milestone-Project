...
def webhook(request):
    ...
    event_map = {
        ...
        'payment_intent.payment_failed': webhook_handler.handle_webhook_payment_intent_payment_failed,
    }
    ...
    event_handler = event_map.get(event_type, webhook_handler.handle_event)
